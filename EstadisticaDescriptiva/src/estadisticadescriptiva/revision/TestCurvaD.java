...
public class TestCurvaD {
    ...
    public static void main(String[] args) {
        ...
        try {
            DatosEnBruto dE = new DatosEnBruto(new ArchivoDeDatos("poisson.txt", ",").getDatos(true));
            ...
            //Distribucion dist = new DistribucionBinomial(5,0.42);
            //Distribucion dist = new DistribucionNormal(dE.calcularMedia(),dE.calcularDeviacionE());
            Distribucion dist = new DistribucionPoisson(dE.calcularMedia());
            System.out.println("maxP: " + dist.probabilidad(dE.calcularMedia()));
            Distribucion n = new DistribucionNormal(dist.calcularMedia(),dist.calcularDesviacionE());
            System.out.println("maxNprob: " + n.probabilidad(dE.calcularMedia()));
